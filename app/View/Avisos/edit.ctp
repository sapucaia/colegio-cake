...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Remover'), array('action' => 'delete', $this->Form->value('Aviso.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Aviso.id'))); ?></li>
